...
struct BoxBreathingView: View {
    ...
    private var breathingCircle: some View {
        ZStack {
            ...
            // Main breathing circle with subtle square morph during hold
            RoundedRectangle(cornerRadius: cornerRadiusForPhase)
                .fill(
                    RadialGradient(
                        colors: [
    ...
    private var cornerRadiusForPhase: CGFloat {
        switch practiceManager.currentPhase {
        case .hold: return 32  // Subtle square hint
        case .idle, .inhale, .exhale: return 80  // Circle
        }
    }
